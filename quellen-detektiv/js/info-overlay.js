...
window.MP_INFO = {
  id: 'quellen-detektiv',
  emoji: '🕵️',
  titel: 'Quellen-Detektiv',
  untertitel: 'Was KI-Zusammenfassungen verschweigen und erfinden',
  zielgruppe: '7.–9. Klasse · 13–15 Jahre',
  dauer: '45–90 Minuten',
  technik: 'Läuft im Browser',
  worumGehts: 'Du bekommst eine Linksammlung zu Themen wie TikTok und Dopamin, Gaming oder Deepfakes. Zu jedem Artikel gibt es den echten Originaltext — und daneben eine Zusammenfassung, die angeblich eine KI geschrieben hat. In dieser Zusammenfassung stecken Fehler.',
  ablauf: [
    'Ein Thema aus der Linksammlung auswählen.',
    'Originaltext links und KI-Zusammenfassung rechts vergleichen.',
    'Verdächtige Stellen markieren und einordnen: verdrehte Zahl, erfundene Aussage, falscher Autor?',
    'Am Ende die Auflösung aufdecken und gemeinsam besprechen, was übersehen wurde.'
  ],
  lernziel: 'KI-Texte klingen souverän und flüssig — auch dann, wenn Zahlen verdreht, Studien erfunden oder Aussagen ins Gegenteil verkehrt sind. Aus 38.935 Befragten werden 3.800, aus einem „kein Zusammenhang nachweisbar" wird ein Beleg. Wer den Unterschied einmal selbst gesucht hat, glaubt Zusammenfassungen nicht mehr ungeprüft.',
  uebersichtUrl: '../'
};
...
#mp-info-kopf {\
  padding: 26px 26px 20px; border-radius: 20px 20px 0 0; color: #fff;\
...
#mp-info-koerper { padding: 22px 26px 26px; }\
#mp-info-koerper h3 {\
...
#mp-info-fuss { display: flex; flex-wrap: wrap; gap: 10px; margin-top: 24px; }\
...
#mp-info-schliessen:hover { background: rgba(255,255,255,.36); }\
@media (max-width: 520px) {\
  #mp-info-kopf { padding: 22px 20px 17px; } #mp-info-koerper { padding: 19px 20px 22px; }\
  #mp-info-kopf h2 { font-size: 20px; } #mp-info-tab { left: 10px; bottom: 10px; padding: 9px 14px; font-size: 13px; }\
}\
@media (prefers-reduced-motion: reduce) {\
  ...
  wurzel.insertAdjacentHTML('beforeend',
    '<button id="mp-info-tab" type="button" aria-haspopup="dialog">' +
      '<span aria-hidden="true">ℹ️</span><span>Was ist das?</span>' +
    '</button>' +
