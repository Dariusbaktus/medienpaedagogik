...
window.MP_INFO = {
  id: 'tiktok-detektiv',
  emoji: '📱',
  titel: 'TikTok-Detektiv',
  untertitel: 'Was Videos über dich verraten, ohne dass du es merkst',
  zielgruppe: '7.–10. Klasse · 12–16 Jahre',
  dauer: '45–90 Minuten',
  technik: 'Läuft im Browser',
  worumGehts: 'Jemand behauptet etwas — „Ich war das Wochenende bei meiner Oma in Hamburg." In einem nachgebauten TikTok-Profil suchst du nach Details, die diese Aussage stützen oder widerlegen: Spiegelungen in Fenstern, Schattenrichtungen, Steckdosen, WLAN-Namen, Hintergrundgeräusche.',
  ablauf: [
    'Die Fallakte lesen: Was ist passiert, was behauptet die verdächtige Person?',
    'Das Profil durchsuchen — Videos, Kommentare, Tonspuren.',
    'Auf die Lupen im Video tippen, um Details heranzuzoomen.',
    'Indizien an die Aussagen anheften und ein Urteil fällen: Wahrheit oder Lüge?'
  ],
  lernziel: 'Diese Ermittlungsmethode heißt OSINT — Recherche mit frei zugänglichen Quellen. Das Spiel dreht die Perspektive am Ende um: Wenn eine gelbe Straßenbahn in einer Fensterscheibe den Aufenthaltsort verrät, dann verraten deine eigenen Videos genauso viel. Wohnort, Schule, Tagesablauf.',
  uebersichtUrl: '../'
};
